...
経験談: 一般会話だとツール呼び出しの判定がシビアすぎて難しさある
（レスポンス速度が求められるとキツイ）
...
- **レスポンス高速化**
    ...
    - [事前検索](https://arxiv.org/abs/2403.05676)、[予測して準備](https://arxiv.org/abs/2508.04403)
...
- 短期〜長期記憶、記憶整理まで手法が多彩 → 要件に応じた設計が必要
